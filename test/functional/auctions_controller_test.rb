...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { auction_date: @auction.auction_date, file_date: @auction.file_date, html_file: @auction.html_file, pdf_file: @auction.pdf_file }
    end
  ...
  test "should update auction" do
    put :update, id: @auction, auction: { auction_date: @auction.auction_date, file_date: @auction.file_date, html_file: @auction.html_file, pdf_file: @auction.pdf_file }
    assert_redirected_to auction_path(assigns(:auction))
  end
